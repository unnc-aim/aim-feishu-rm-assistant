...
- 每月推送: 每月 1 日在设定时间推送上一个自然月 (上月 1 日 0 点至本月 1 日 0 点) 的内容, 卡片下方附"本月动态"及其总结。
...
- 发送"测试推送"/"测试周推送"/"测试月推送" (或"立即"开头等价命令) 可分别立即生成日报/周报/月报窗口的推送, 用于验证推送链路; 启动日志会打印每个订阅的下次触发时间 (本地时区), 便于排查时区问题。
